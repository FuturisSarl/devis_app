...
class ToitureActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_composants_toiture)
        list_grouped_elements.layoutManager = LinearLayoutManager(this)
        list_grouped_elements.adapter = GroupedElementsRecyclerAdapter(this, DataManager.projects[0].composants[3].elements)
